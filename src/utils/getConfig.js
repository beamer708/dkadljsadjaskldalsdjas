...
function getConfig() {
  ...
  return {
    ...
    staffForumChannelId:        process.env.STAFF_FORUM_CHANNEL_ID       || fileConfig.staffForumChannelId,
    suggestionChannelId:        process.env.SUGGESTION_CHANNEL_ID        || fileConfig.suggestionChannelId,
    suggestionForumChannelId:   process.env.SUGGESTION_FORUM_CHANNEL_ID  || fileConfig.suggestionForumChannelId,
